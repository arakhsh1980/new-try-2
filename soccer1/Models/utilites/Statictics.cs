...
namespace soccer1.Models
{
    ...
    [Flags] public enum RoboPartType { none = 0, aimer1 = 1, shild1 = 2, battry1 = 3, shooter1 = 4, engine1 = 5 }
    ...
    {        
        ...
        public static DateTime BaseStartTime = new DateTime(2020, 1, 1, 1, 1, 1);
        ...
        public const int StartingAlminum = 0;

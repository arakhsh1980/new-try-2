...
namespace soccer1.Models
{
    ...
    //        connectionInfos[ConnectionId].EventMassage = MatchMassageType.NothingNew.ToString();
    ...
    //    public static void AddPlayerEvent(int ConnectionId, MatchMassageType massageType, string eventMassage)
    //    {

    //        if (massageType == MatchMassageType.NothingNew) { return; }
    //        if (connectionInfos[ConnectionId].EventMassage == MatchMassageType.Disconcted.ToString()) { return; }
    //        Log.AddPlayerLog(ConnectionId, " adding event:  " + massageType.ToString() + "st: " + eventMassage);
    //        if (connectionInfos[ConnectionId].EventMassage == MatchMassageType.NothingNew.ToString() || connectionInfos[ConnectionId].EventMassage == "")
    //        {
    ...
    //        AddPlayerEvent(playerInfo.connectedId, MatchMassageType.NothingNew, "");
    ...
    //        AddPlayerEvent(connectionId, MatchMassageType.Disconcted, "");
    ...
    //            connectionInfos[i].EventMassage = MatchMassageType.NothingNew.ToString();

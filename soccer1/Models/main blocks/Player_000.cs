        ...
        */
        ...
        public void UpdateSpnserPorperty()
        {
            ...
            if (true)//10 < (clapsedTime))
            {
                ...
                sponsorAlmimun += thisplayerSponser.AlminumPerMinute * clapsedTime;
                sponsorGold += thisplayerSponser.goldPerMinute * clapsedTime;
                if (thisplayerSponser.AlminumMaxCap < sponsorAlmimun) { sponsorAlmimun = thisplayerSponser.AlminumMaxCap; }
                if (thisplayerSponser.goldMaxCap < sponsorGold) { sponsorGold = thisplayerSponser.goldMaxCap; }
            }
            SaveChanges();
        }
        ...
        public PlayerForSerial ReturnForSerialize()
        {
            ...
            serialplayer.level = PlayerProperty.level;
            ...
            serialplayer.PowerLevel = PowerLevel;
            ...
            serialplayer.sponsorAlminumMax = thisPlayerSp.AlminumMaxCap;
            serialplayer.sponsorGoldMAX = thisPlayerSp.goldMaxCap;
            serialplayer.sponsorName = thisPlayerSp.name;
            serialplayer.sponsorGoldPerMinute = thisPlayerSp.goldPerMinute;
            serialplayer.sponsorAlmimunPerMinute = thisPlayerSp.AlminumPerMinute;

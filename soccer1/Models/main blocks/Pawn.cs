...
namespace soccer1.Models.main_blocks
{
    ...
    public class Pawn
    {
        ...
        public long ReturnRoboCode()
        {
            ...
            code += (long)parts[0].ReturnCode() * 1000 * 100;
            code += (long)parts[1].ReturnCode() * 1000 * 100 * pCMX;
            code += (long)parts[2].ReturnCode() * 1000 * 100 * pCMX * pCMX;
            code += (long)parts[3].ReturnCode() * 1000 * 100 * pCMX * pCMX * pCMX;
            code += (long)parts[4].ReturnCode() * 1000 * 100 * pCMX * pCMX * pCMX * pCMX;
